...
const ReviewForm = ({ data, updateFieldHandler }) => {
  ...
  return (
    <div id="review-form">
      <div id="form-control" className="flex gap-10 mt-10">
        ...
        <label className="flex flex-col justify-center items-center">
          ...
          <BsEmojiGrin id="very_satisfied" className={`size-7 mb-2 cursor-pointer hover:fill-[#9370DB] transition fill-current peer-checked:fill-[#9370DB]`} />
        ...
        <label name="review" className="flex flex-col justify-center items-center">
          ...
          <BsEmojiSmile className="size-7 mb-2 cursor-pointer hover:fill-[#9370DB] transition fill-current peer-checked:fill-[#9370DB]" />
          <p>Satisfeito</p>
        </label>
        ...
        <label name="review" className="flex flex-col justify-center items-center">
          ...
          <BsEmojiNeutral className="size-7 mb-2 cursor-pointer hover:fill-[#9370DB] transition fill-current peer-checked:fill-[#9370DB]" />
          <p>Neutro</p>
        </label>
        ...
        <label name="review" className="flex flex-col justify-center items-center">
          ...
          <BsEmojiFrown className="size-7 mb-2 cursor-pointer hover:fill-[#9370DB] transition fill-current peer-checked:fill-[#9370DB]" />
          <p>Insatisfeito</p>
        </label>
      </div>
